export const sharedCopy = {
  ...
  errorWorkerLoad: "Couldn't load, check your connection and try again.",
  preview: 'Preview',
  verify:
    'Check the result before you rely on it. This is a Hobby project, bugs happen, no warranty.',
  verifyTerms: 'Terms',
  verifyReport: 'Something off? Tell me.',
};
